...
const unsigned char* bitmap_icons[12] = {
  ...
  bitmap_icon_ble,
  bitmap_icon_wifi,
  bitmap_icon_analyzer,   // reuse analyzer icon for Spectrum
  bitmap_icon_about,
  bitmap_icon_setting
};
...
void about() {
  ...
  u8g2.drawStr(0, 15, "minta.official");
  u8g2.drawStr(0, 35, "youtube/minta18596");
  u8g2.drawStr(0, 55, "github/minta1234");
  u8g2.sendBuffer();
}
...
void setup() {
  ...
  int16_t creditWidth = u8g2.getUTF8Width("by Minta-official");
  int16_t creditX = (106 - creditWidth) / 2;
  u8g2.setCursor(creditX, 40);
  u8g2.print("by Minta-official");
